...
export const API_CONFIG = {
  ...
  OPENAI_API_KEY: process.env.OPENAI_API_KEY || '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',
  ...
  OPENROUTER_API_KEY: process.env.OPENROUTER_API_KEY || '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',
...
- Governing Law: New York law`,
  ...
  USER_PROMPT_TEMPLATE: (userPrompt) => `Generate a professional contract for: ${userPrompt}
...
export const AI_ERROR_MESSAGES = {
  API_KEY_MISSING: 'OpenRouter API key is not configured. Please add your API key to the configuration.',
  API_REQUEST_FAILED: 'Failed to connect to OpenRouter API. Please check your internet connection.',
  INVALID_RESPONSE: 'Received invalid response from AI service. Please try again.',
  RATE_LIMIT: 'Rate limit exceeded. Please wait a moment and try again.',
  QUOTA_EXCEEDED: 'API quota exceeded. Please check your OpenRouter account.',
  GENERIC_ERROR: 'An error occurred while generating AI content. Please try again.',
  OPENROUTER_SPECIFIC: 'OpenRouter service error. Please check your API key and account status.'
};
...
export const API_ERROR_MESSAGES = {
  ...
  API_KEY_MISSING: 'OpenAI API key is not configured. Please add your API key to the configuration.',
  API_REQUEST_FAILED: 'Failed to connect to AI API. Please check your internet connection.',
  RATE_LIMIT: 'Rate limit exceeded. Please wait a moment and try again.',
